...
handled_functions = {
    ...
    'bond': [1, 6],  # tested and verified: 1
...
help_max_fct_bonds_bi = 'Max. force constant for bonds BI initial guess (kJ.mol⁻¹.nm⁻²)\nIf BI fit exceeds this, starting guess resets to half this value'
help_max_fct_bonds = 'Max. force constants for bonds function 1 (kJ.mol⁻¹.nm⁻²)'
help_max_fct_angles_bi = 'Max. force constant for angles BI initial guess (kJ.mol⁻¹)\nIf BI fit exceeds this, starting guess resets to half this value'
...
help_max_fct_dihedrals_bi_with_mult = 'Max. force constant for dihedrals BI initial guess, functions 1, 4, 9 (abs. kJ.mol⁻¹)\nIf BI fit exceeds this, starting guess resets to half this value'
help_max_fct_dihedrals_bi_without_mult = 'Max. force constant for dihedrals BI initial guess, function 2 (abs. kJ.mol⁻¹.rad⁻²)\nIf BI fit exceeds this, starting guess resets to half this value'
